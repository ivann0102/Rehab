...
namespace RehabCV.Migrations
{
    ...
    [Migration("20230408080255_AddCard")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RehabCV.Models.Card", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<List<DateTime>>("Lessons")
                        .HasColumnType("timestamp with time zone[]");

                    b.Property<string>("RehabilitationResults")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RehabCV.Models.Card", b =>
                {
                    b.HasOne("RehabCV.Models.Therapist", "Therapist")
                        .WithMany("Cards")
